$(document).ready(function(){
	...
	function switch_theme(theme_name)
	{
        ...
        //remove... dun need
		//$('#bs-css').attr('href','css/backend/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	$('.thumbnails').on('click','.gallery-delete',function(e){
        ...
        var src =   ($(this).parents('.thumbnail').attr('data-src'));
        $.ajax({
            url: 'http://'+window.location.host+'/admin/topicimg/delete_image',
            type:"POST",
            data:{id:id,src:src},
            dataType:"html",
            beforeSend:function(){
