...
class OrderController extends AdminGlobalController
{
    ...
    public function indexAction()
    {
        ...
        $columns = array(
            ...
            array('title' =>'Table', 'db' => 'name','dt' => 1,'select'=>'name','prefix'=>'t', 'search'=>true, 'type' => 'text','dataSelect' => Utility::getTableForSelect() ),
        ...
        return new ViewModel(array('table' => $table,
            'title' => $this->translator->translate('Order Manage')));
    }
